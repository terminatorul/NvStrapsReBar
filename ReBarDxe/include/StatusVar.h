...
typedef enum StatusVar
{
    ...
    StatusVar_BadSetupVarAttributes = 164u,
    StatusVar_AmbiguousSetupVariable = 165u,
    StatusVar_MissingSetupVariable = 166u,
...
typedef enum EFIErrorLocation
{
    ...
    EFIError_EnumVar,
    EFIError_EnumSetupVarSize,
    EFIError_ReadSetupVar,
    EFIError_ReadSetupVarSize,
    EFIError_AllocateSetupVarName,
    EFIError_AllocateSetupVarData,
