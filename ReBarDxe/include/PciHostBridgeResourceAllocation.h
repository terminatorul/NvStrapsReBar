...
#ifndef NV_STRAPS_REBAR_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_H_
#define NV_STRAPS_REBAR_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_H_
...
#endif         // !defined(NV_STRAPS_REBAR_PCI_HOST_BRIDGE_RESOURCE_ALLOCATION_H_)
